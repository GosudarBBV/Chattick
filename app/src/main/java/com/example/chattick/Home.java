...
import com.example.chattick.fragments.ChatsFragment;
import com.example.chattick.fragments.ProfileFragment;
import com.example.chattick.fragments.UsersFragment;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                startActivity(new Intent(Home.this, Start.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                return true;
        }
        return false;
    }
